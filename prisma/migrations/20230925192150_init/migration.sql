...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicDepaermentId_fkey" FOREIGN KEY ("academicDepaermentId") REFERENCES "academic_department"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
